...
# something is clearly wrong. Somewhere the number of rows (entries) per family (898 total)
# doesn't equal the kid count for that family (899 total):
...
fam.max().iloc[32]
# or more obviously, print out the relevant part of the dataframe:
gdf.loc[gdf['Family'] == '130'] # notice the family numbers are strings, not integers!
# so one row (kid) is missing for this family! poor kid...
